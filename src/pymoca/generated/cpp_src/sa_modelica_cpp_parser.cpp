...
antlr4::tree::ParseTree* get_parse_tree_stored_definition(ModelicaParser *parser) {return parser->stored_definition();}

antlr4::tree::ParseTree* get_parse_tree(ModelicaParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(ModelicaParser*)> table
    {
        {"stored_definition", &get_parse_tree_stored_definition}
    };
